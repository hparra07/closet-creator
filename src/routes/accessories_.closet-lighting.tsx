...
import heroImg from "@/assets/accessories/closet-lighting-banner.webp";
import { pageHead, SITE_URL } from "@/lib/pageHead";
import countertopImg1 from "@/assets/accessories/countertop/CTL1-custom-led-countertop-lighting-with-plant-decor-1.webp";
import countertopImg2 from "@/assets/accessories/countertop/CTL2-modern-led-task-lighting-above-countertop.webp";
import countertopImg3 from "@/assets/accessories/countertop/CTL3-custom-closet-task-and-countertop-led-lighting.webp";
import countertopImg4 from "@/assets/accessories/countertop/CTL4-luxury-countertop-LED-accent-lighting-with-modern-decor.webp";
import countertopImg5 from "@/assets/accessories/countertop/CTL5-custom-closet-countertop-LED-ribbon-lighting-accessory-1024x819.webp";
...
import wardrobeImg2 from "@/assets/accessories/wardobe/WL2-custom-led-closet-rod-lighting-with-puck-lights.webp";
import wardrobeImg3 from "@/assets/accessories/wardobe/WL3-modern-closet-with-led-shelf-and-drawer-lighting.webp";
import wardrobeImg4 from "@/assets/accessories/wardobe/WL4-elegant-wardrobe-with-led-lighting-in-modern-walk-in-closet.webp";
import accentImg1 from "@/assets/accessories/accent-shelf-ligths/SAL1-custom-shelf-lighting-in-modern-display-unit.webp";
import accentImg2 from "@/assets/accessories/accent-shelf-ligths/SAL2-closet-shelf-and-wardrobe-lighting-with-storage-boxes.webp";
import accentImg3 from "@/assets/accessories/accent-shelf-ligths/SAL3-shelf-and-accent-lighting-for-modern-closet-display.webp";
...
import accentImg6 from "@/assets/accessories/accent-shelf-ligths/SAL6-custom-wine-rack-with-led-accent-lighting-in-modern-kitchen.webp";
...
export const Route = createFileRoute("/accessories_/closet-lighting")({
  head: () =>
    pageHead({
      ...
      description: "Smart & modern custom lighting options for your closet or pantry, designed and installed by JL Closets across South Florida.",
